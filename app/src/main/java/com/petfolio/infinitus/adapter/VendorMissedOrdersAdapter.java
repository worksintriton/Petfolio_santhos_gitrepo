...
public class VendorMissedOrdersAdapter extends  RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private  String TAG = "VendorMissedOrdersAdapter";
    ...
    public VendorMissedOrdersAdapter(Context context, List<VendorOrderResponse.DataBean> newOrderResponseList, int size) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_vendor_missed_appointment, parent, false);
    ...
    private void initLayoutOne(ViewHolderOne holder, final int position) {
        ...
        if(newOrderResponseList.get(position).getOrder_booked_at() != null){
            holder.txt_cancelledon.setText("Cancelled on:"+" "+newOrderResponseList.get(position).getOrder_deliver_date());
    ...
    static class ViewHolderOne extends RecyclerView.ViewHolder {
        public TextView txt_orderid,txt_producttitle,txt_service_cost,txt_cancelledon;
